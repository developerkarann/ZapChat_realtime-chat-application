...
const DeleteChatMenuDialog = ({ dispatch, deleteMenuAnchor }) => {
    ...
    const leaveGroupHandler = () => {
        closeHandler()
        leaveGroup('Levaing Group...', selectedDeleteChat.chatId)
    }
    const deleteChatHandler = () => {
        closeHandler()
        deleteChat('Delete Chat...', selectedDeleteChat.chatId)
    }
    ...
    return (
        <>
            <Menu open={isDeleteMenu} onClose={closeHandler} anchorEl={deleteMenuAnchor}
                anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }} transformOrigin={{ vertical: 'center', horizontal: 'center' }} >
                ...
                >
                    {selectedDeleteChat.groupChat ? <> <ExitToAppIcon /> <Typography>Leave Group</Typography> </>
